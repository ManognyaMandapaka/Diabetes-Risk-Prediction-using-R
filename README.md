# Diabetes Risk Prediction Using Behavioral Health Indicators
...
1. Clone the repository and open the R script or RMarkdown file.
2. Install required packages (`rpart`, `ggplot2`, `caret`, etc.)
3. Load the cleaned dataset and run the models.
4. Review outputs: confusion matrices, accuracy, and plots.
